    ...
    for (var count = 0; count < totalMovies; count++) {
		...
		if (movie_array[count].GamePopularity == category) {
			...
			<div class="row">\
                                    ...
                                    <div class = "row">\
											<button href="#" data-toggle="modal" data-dismiss="Modal" item="' + count + '" type="button" class="btn btn-warning btn-sm text-dark" onClick="addFavourites(this)" style="color: #FFFFFF; font-family: Verdana;margin-bottom: 5px">Add to favourites</button></div>\
									\
                                         </div>                                                                                                                                                                                                 \
                                    </div>                                                                                                                                                                                                      \
                                                                                                                                                                                                                                         \
